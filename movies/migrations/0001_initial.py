    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.PositiveSmallIntegerField(default='2023', verbose_name='Год производства')),
                ('country', models.CharField(max_length=50, verbose_name='Страна')),
                ('world_primier', models.DateField(default=datetime.date.today, verbose_name='Премьера')),
